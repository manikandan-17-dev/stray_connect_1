...
class _VolunteerDashboardState extends ConsumerState<VolunteerDashboard> {
  ...
  final List<Widget> _screens = const [
    _VolunteerFeedPlaceholder(), // Keeping placeholder for feed for now
    MyReportsScreen(),
    NotificationsScreen(),
    ProfileScreen(),
  ];
...
class _VolunteerFeedPlaceholder extends StatelessWidget {
  const _VolunteerFeedPlaceholder();
  ...
  Widget build(BuildContext context) {
    return Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.volunteer_activism, size: 100, color: AppTheme.primaryOrange),
            ...
            const Padding(
              ...
              child: Text(
                'Nearby rescue requests will appear here soon.',
